...
## Vectors creation {#solution_new_vecs}
...
## Vectorisation {#solution_vec_ion}
...
## Indexing vectors {#solution_vec_ind}
...
## Columns selection: `dplyr::select()` {#solution_select}
...
## Rows selection: `dplyr::slice()` and `dplyr::filter()` {#solution_filt}
...
## Rows sorting: `dplyr::arrange()` {#solution_arr}
...
## Making new columns: `dplyr::mutate()` and `dplyr::transmute()` {#solution_mutate}
...
## Operations with several columns: `across()` {#solution_across}
...
## Merging dataframes: *_join {#solution_join}
...
## Построение графиков в `ggplot2` {#ggplot2_solutions}
...
## Одновыборочный t-test {#one_ttest_solutions}
...
## Двухвыборочный зависимый t-test {#dep_ttest_solutions}
...
## Двухвыборочный независимый t-test {#ind_ttest_solutions}
...
## Исследование набора данных Backpack {#backpack_solutions}
...
## Коэффициент корреляции {#cor_solutions}
